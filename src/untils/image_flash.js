    ...
    function a(f, e, t, i, s, l, x, n) {
        ...
        if ("string" == typeof g) {
            ...
            y.font = 35 + u + 'px "FZLanTingHei-B-GBK"',
            y.textAlign = "center",
            ...
            var A = (t.x - e.x) / l
              , T = (t.y - e.y) / l
              , M = (i - 1) / l
              , b = "undefined" != typeof window && (g.naturalWidth > g.width)? g.naturalWidth : g.width
              , B = x;
            60 > B && (B = 30 * Math.floor(B / 30));
            var S = b * (1 + M * B);
            if (y.drawImage(g, e.x + A * B, e.y + T * B, S,0.5625 * S),
            16 === s) {
                var F = x / 140;
