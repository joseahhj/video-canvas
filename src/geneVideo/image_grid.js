...
function n(a) {
    ...
    var g;
    //try {
    g = createCanvas(3304, 1860) //document.createElement("canvas"),
        // g.width = 3304,
        // g.height = 1860
        //} catch (h) {
        // var d = e("canvas");
...
function r(e, a, t, n, i, o, c, s, u, l, v) {
    var p = o.context,
        ...
        h = o.passerpipe,
        d = o.images[0];
    if (p.drawImage(d, a, t, n, i, 0, 0, 1280, 720),
        l)
        if (v++,
            8 > v)
            setTimeout(function() {
        ...
        var m = 1,
            ...
            k = setInterval(function() {
                return m -= .03,
                    ...
                    o.context.drawImage(o.images[1], 0, 0, 1280, 720),
